...
function () {
  ...
  _createClass(BadgerAccordion, [{
    ...
    value: function handleClick(targetHeader, headerIndex) {
	  ...
	  if (headerIndex > paso_actual) return;
	  headerIndexActual = headerIndex;
	  $(".loader").fadeIn("slow");
	  var stateActual = this.getState([headerIndex])[0].state;
	  var mapaTiendasDisplay = $("#mapaTiendas").css("display");
	  if (headerIndex == "5" && stateActual == "closed" && mapaTiendasDisplay == "none") {
		  $('#mapaArmaParrillada').show();
	  }
//	  if (mapaTiendasDisplay != "none") {
//		  var id_activo = acordeonStores.headers[headerIndex].id;
//		  $(".botonesTiendas").css("background-color","#000000f0");
//		  $("#" + id_activo).css("background-color","#B32524");
//		  $('html,body').animate({ scrollTop: $("#" + id_activo).offset().top }, 500);
//	  } 
//	  var div_tienda_seleccionada = $(".js-badger-accordion2 > dd.badger-accordion__panel.-ba-is-active > div");
//	  if (div_tienda_seleccionada.length > 0) {
//		  var id_tienda = div_tienda_seleccionada[0].id;
//		  var id_store = id_tienda.split("_")[1];
//		  $("#store_" + id_store).owlCarousel({
//			dots: false,
//			margin:50,
//			nav: true,
//			loop:true,
...
//	  }
      ...
      if (animationAction !== undefined && headerIndex !== undefined) {
        if (animationAction === 'closed') {
          ...
          panelToOpen.onCSSTransitionEnd(function () {
			var mapaTiendasDisplay = $("#mapaTiendas").css("display");
			if (mapaTiendasDisplay != "none" && headerIndexActual == headerIndex) {
				  var id_activo = acordeonStores.headers[headerIndex].id;
				  $(".botonesTiendas").css("background-color","#000000f0");
				  $("#" + id_activo).css("background-color","#B32524");
				  $('html,body').animate({ scrollTop: $("#" + id_activo).offset().top }, 500);
    ...
    value: function calculateAllPanelsHeight() {
	  ...
	  if ($("#contenedorGral").find(".slick-slide").length > 0) {
		  setTimeout(function () {
