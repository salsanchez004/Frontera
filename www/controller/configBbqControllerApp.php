...
function getRecetas() {
	...
	<div id="lpmoReceta3" class="receta wow slideInLeft" style="border: 3px #FFF solid;">
		 <div>
			  <img src="'.$url_controller.'images/recipes/lpmo3_play.jpg" alt="image" style="margin: auto; display: block;" class="img-fluid" onclick="playVideoRecipe(\'OoDkTUWDL4c\')">

			 <!--
			 <img src="'.$url_controller.'images/recipes/lpmo3.jpg" alt="image" style="margin: auto; display: block;" class="img-fluid">
			-->

			 <h4 class="tituloReceta">Burrito de Arrachera</h4>
			  <h5 class="subtituloReceta">con Los Parrilleros Mamones</h5>
			  <img src="'.$url_controller.'images/recipes/dots.jpg" alt="image" style="margin: auto; display: block; margin-bottom: 15px;">
		 </div>
	 </div>
	 <div id="lpmoReceta4" class="receta wow slideInLeft" style="border: 3px #FFF solid;">
		 <div>
			  <img src="'.$url_controller.'images/recipes/lpmo4_play.jpg" alt="image" style="margin: auto; display: block;" class="img-fluid" onclick="playVideoRecipe(\'nQYehgDvG-g\')">

			 <!--
			 <img src="'.$url_controller.'images/recipes/lpmo4.jpg" alt="image" style="margin: auto; display: block;" class="img-fluid">
			-->

			 <h4 class="tituloReceta">Tacos de cecina en salsa verde</h4>
				<h5 class="subtituloReceta">con Los Parrilleros Mamones</h5>
			  <img src="'.$url_controller.'images/recipes/dots.jpg" alt="image" style="margin: auto; display: block; margin-bottom: 15px;">
		 </div>
	 </div>
	 <div id="lpmoReceta5" class="receta wow slideInLeft" style="border: 3px #FFF solid;">
		 <div>
			  <img src="'.$url_controller.'images/recipes/lpmo5_play.jpg" alt="image" style="margin: auto; display: block;" class="img-fluid" onclick="playVideoRecipe(\'Rz5_yE7hupA\')">

			 <!--
			 <img src="'.$url_controller.'images/recipes/lpmo5.jpg" alt="image" style="margin: auto; display: block;" class="img-fluid">
			-->

			 <h4 class="tituloReceta">Hamburguesa regia</h4>
				<h5 class="subtituloReceta">con Los Parrilleros Mamones</h5>
			  <img src="'.$url_controller.'images/recipes/dots.jpg" alt="image" style="margin: auto; display: block; margin-bottom: 15px;">
		 </div>
	 </div>
	 <div id="lpmoReceta6" class="receta wow slideInLeft" style="border: 3px #FFF solid;">
		 <div>
			  <img src="'.$url_controller.'images/recipes/lpmo6_play.jpg" alt="image" style="margin: auto; display: block;" class="img-fluid" onclick="playVideoRecipe(\'K0KKaHgaH-0\')">

			 <!--
			 <img src="'.$url_controller.'images/recipes/lpmo6.jpg" alt="image" style="margin: auto; display: block;" class="img-fluid">
			-->

			 <h4 class="tituloReceta">Empanadas de papa con longaniza</h4>
				<h5 class="subtituloReceta">con Los Parrilleros Mamones</h5>
			  <img src="'.$url_controller.'images/recipes/dots.jpg" alt="image" style="margin: auto; display: block; margin-bottom: 15px;">
		 </div>
	 </div>
	 <div id="lpmoReceta7" class="receta wow slideInLeft" style="border: 3px #FFF solid;">
		 <div>
			  <img src="'.$url_controller.'images/recipes/lpmo7_play.jpg" alt="image" style="margin: auto; display: block;" class="img-fluid" onclick="playVideoRecipe(\'aXi5Ubq_sCE\')">

			 <!--
			 <img src="'.$url_controller.'images/recipes/lpmo7.jpg" alt="image" style="margin: auto; display: block;" class="img-fluid">
			-->

			 <h4 class="tituloReceta">Fajitas de Arrachera</h4>
				<h5 class="subtituloReceta">con Los Parrilleros Mamones</h5>
			  <img src="'.$url_controller.'images/recipes/dots.jpg" alt="image" style="margin: auto; display: block; margin-bottom: 15px;">
		 </div>
	 </div>
...
function getBotonesRecetas() {
	...
	<div id="recetaLPMO" class="recetasClass row" style="padding-left: 20px;padding-top: 20px;">
		...
		<div style="background: linear-gradient(#424141,black); width: 92%;height: 50px;display: inline-flex;text-align: left; margin-bottom: 5px; align-items: center" onclick="selectRecipe(\'lpmoReceta2\');">
			...
			<span id="txtresLPMO2" class="subcontent recetaPointer fontSizeTablet" style="padding-left: 10px; font-size: 12px; line-height: 15px">Torta de chorizo y arrachera</span>
		</div>
		...
		<div style="background: linear-gradient(#424141,black); width: 92%;height: 50px;display: inline-flex;text-align: left; margin-bottom: 5px; align-items: center" onclick="selectRecipe(\'lpmoReceta3\');">
			<img src="'.$url_controller.'images/recipes/lpmo3.jpg" style="height: 100%;">							
			<span id="txtresLPMO3" class="subcontent recetaPointer fontSizeTablet" style="padding-left: 10px; font-size: 12px; line-height: 15px">Burrito de arrachera</span>
		</div>
		<div style="border-radius: 0px 10px 10px 0px;margin-right: 10px;width: 4%; align-items: center;background-image: url(images/FondoFlechaMenu.png);height: 50px;padding: 2px;display: inline-flex;" onclick="selectRecipe(\'lpmoReceta3\');">
			<img src="images/FlechaMenu.png" class="flechaMenu pull-right">
		</div>
		<div style="background: linear-gradient(#424141,black); width: 92%;height: 50px;display: inline-flex;text-align: left; margin-bottom: 5px; align-items: center" onclick="selectRecipe(\'lpmoReceta4\');">
			<img src="'.$url_controller.'images/recipes/lpmo4.jpg" style="height: 100%;">							
			<span id="txtresLPMO4" class="subcontent recetaPointer fontSizeTablet" style="padding-left: 10px; font-size: 12px; line-height: 15px">Tacos de cecina en salsa verde</span>
		</div>
		<div style="border-radius: 0px 10px 10px 0px;margin-right: 10px;width: 4%; align-items: center;background-image: url(images/FondoFlechaMenu.png);height: 50px;padding: 2px;display: inline-flex;" onclick="selectRecipe(\'lpmoReceta4\');">
			<img src="images/FlechaMenu.png" class="flechaMenu pull-right">
		</div>
		<div style="background: linear-gradient(#424141,black); width: 92%;height: 50px;display: inline-flex;text-align: left; margin-bottom: 5px; align-items: center" onclick="selectRecipe(\'lpmoReceta5\');">
			<img src="'.$url_controller.'images/recipes/lpmo5.jpg" style="height: 100%;">							
			<span id="txtresLPMO5" class="subcontent recetaPointer fontSizeTablet" style="padding-left: 10px; font-size: 12px; line-height: 15px">Hamburguesa regia</span>
		</div>
		<div style="border-radius: 0px 10px 10px 0px;margin-right: 10px;width: 4%; align-items: center;background-image: url(images/FondoFlechaMenu.png);height: 50px;padding: 2px;display: inline-flex;" onclick="selectRecipe(\'lpmoReceta5\');">
			<img src="images/FlechaMenu.png" class="flechaMenu pull-right">
		</div>
		<div style="background: linear-gradient(#424141,black); width: 92%;height: 50px;display: inline-flex;text-align: left; margin-bottom: 5px; align-items: center" onclick="selectRecipe(\'lpmoReceta6\');">
			<img src="'.$url_controller.'images/recipes/lpmo6.jpg" style="height: 100%;">							
			<span id="txtresLPMO6" class="subcontent recetaPointer fontSizeTablet" style="padding-left: 10px; font-size: 12px; line-height: 15px">Empanadas de papa con longaniza</span>
		</div>
		<div style="border-radius: 0px 10px 10px 0px;margin-right: 10px;width: 4%; align-items: center;background-image: url(images/FondoFlechaMenu.png);height: 50px;padding: 2px;display: inline-flex;" onclick="selectRecipe(\'lpmoReceta6\');">
			<img src="images/FlechaMenu.png" class="flechaMenu pull-right">
		</div>
		<div style="background: linear-gradient(#424141,black); width: 92%;height: 50px;display: inline-flex;text-align: left; margin-bottom: 5px; align-items: center" onclick="selectRecipe(\'lpmoReceta7\');">
			<img src="'.$url_controller.'images/recipes/lpmo7.jpg" style="height: 100%;">							
			<span id="txtresLPMO7" class="subcontent recetaPointer fontSizeTablet" style="padding-left: 10px; font-size: 12px; line-height: 15px">Fajitas de Arrachera</span>
		</div>
		<div style="border-radius: 0px 10px 10px 0px;margin-right: 10px;width: 4%; align-items: center;background-image: url(images/FondoFlechaMenu.png);height: 50px;padding: 2px;display: inline-flex;" onclick="selectRecipe(\'lpmoReceta7\');">
			<img src="images/FlechaMenu.png" class="flechaMenu pull-right">
		</div>
	</div>
	<div id="recetaRes" class="recetasClass row" style="padding-left: 20px;padding-top: 20px; display: none">
...
function fechaBlog($creation_time) {
	global $meses;
	$dia_blog = substr($creation_time,8,2);
	$mes_blog = substr($creation_time,5,2);
	$anio_blog = substr($creation_time,0,4);
	$fecha_blog = $dia_blog." de ".strtolower($meses[$mes_blog])." de ".$anio_blog;
	return $fecha_blog;
}

function getBlogSlider() {
	global $log, $db, $url_controller;
	$url_controller_sin_app = str_replace("app/","",$url_controller);
	$html_blog_gral = "";
	$blogs = $db->rawQuery("SELECT id_blog, title, short_desc, path_img, creation_time FROM TBL_BLOG WHERE status = 1 ORDER BY creation_time DESC LIMIT 5");
	for ($b=0; $b<count($blogs); $b++) {
		$blog = $blogs[$b];
		$html_blog = '<div class="item">';
		$html_blog .= '<div class="row" style="margin: 0 auto; text-align: center;">';
		$html_blog .= '<div class="col-md-12 mb-4">';
		$html_blog .= '<img style="cursor:pointer" onclick="viewBlogDetails('.$blog["id_blog"].');" src="'.$url_controller_sin_app.$blog["path_img"].'" alt="blog_'.$b.'" />';
		$html_blog .= '</div>';
		$html_blog .= '<div class="col-md-12 mb-3">';
		$html_blog .= '<h6 style="color:#B32524">'.fechaBlog($blog["creation_time"]).'</h6>';
		$html_blog .= '</div>';
		$html_blog .= '<div class="col-md-12 mb-3" onclick="viewBlogDetails('.$blog["id_blog"].');">';
		$html_blog .= '<h5 style="font-family: Intro; color: white;">'.$blog["title"].'</h5>';
		$html_blog .= '</div>';
		$html_blog .= '<div class="col-md-12">';
		$html_blog .= '<p style="line-height:1.2; min-height: 180px; text-align:justify;">'.$blog["short_desc"].'</p>';
		$html_blog .= '</div>';
		$html_blog .= '<div class="col-md-12">';
		$html_blog .= '<a target="_self" href="javascript:;" onclick="viewBlogDetails('.$blog["id_blog"].');" class="btn btn-large btn-gradient" style="text-transform:inherit; border-radius:10px">Aprender más</a>';
		$html_blog .= '</div>';
		$html_blog .= '</div>';
		$html_blog .= '</div>';

		$html_blog_gral .= $html_blog;
	}
	return $html_blog_gral;
}

function getBlogDetail($id_blog) {
	global $log, $db, $url_controller;
	$url_controller_sin_app = str_replace("app/","",$url_controller);
	$blog = $db->rawQueryOne("SELECT * FROM TBL_BLOG WHERE id_blog = ".$id_blog." AND status = 1");
	$fecha_blog = fechaBlog($blog["creation_time"]);
	$cuerpo_blog = str_replace('src="images', 'src="'.$url_controller_sin_app.'images',$blog["html_body"]);
	$blog_detail = '<div class="row" style="padding-right: 5%; padding-left: 5%; margin: 0 auto;">
						<div class="col-md-12" align="center">
							<span class="date" style="color: #FFF;font-size: 2em;font-family: quadonNormal;">'.$fecha_blog.'</span>
							<h4 class="mt-4 mb-4 tituloLH" style="color:white;font-size: 3em;">'.$blog["title"].'</h4>			
							<img src="'.$url_controller_sin_app.'images/blog/vinetasBlancas.png" class="mt-4" />
						</div>

						<div class="col-md-10 mt-5" style="margin: 0 auto;">'.$cuerpo_blog.'
						</div>
					</div>
					<div class="row" style="padding-bottom: 20px">
						<a class="btn" style="font-size: 16px; background-image: url(\'images/botonRegistro.png\'); text-transform: inherit; margin: 0 auto;" href="javascript:goToSlide(10)">Regresar</a>
					</div>';
	return $blog_detail;
}

function getInfoCarga() {
	global $log, $db, $url_controller;
	$url_controller_sin_app = str_replace("app/","",$url_controller);
	$info_carga = $db->rawQueryOne("SELECT * FROM TBL_INFO_CARGA WHERE status = 1 LIMIT 1");
	if ($db->count > 0) {
		return str_replace("##URL_CONTROLLER##", $url_controller, $info_carga["html_carga"]);
	}
	else return false;
}
...
//			$resultado[] = '<img style="width: 100%; margin: auto; padding: 20px; border-radius: 35px" alt="parrilleroinvitado" src="'.$url_controller.'images/parrillero/dummy.jpg?v='.$vi.'" />';
		...
		$html_blog_slider = getBlogSlider();
//		$log->trace("HTML_BLOG: ".$html_blog_slider);
		$resultado[] = $html_blog_slider;

		$aplica_infoCarga = getInfoCarga(); 
		$resultado[] = $aplica_infoCarga;
		
		$giveaway_file = "giveaway.html";
		if (file_exists($giveaway_file)) {
			$giveaway_html = file_get_contents($giveaway_file);	
//			$msg = str_replace("@@destinatario@@",trim($datos[0]),$msg);
		}
		else {
			$giveaway_html = null;
		}
		$resultado[] = $giveaway_html;
...
//		global $meses, $relativo, $url_controller;
	...
	elseif ($action == "getBlogDetail") {
		$id_blog = $_POST["id_blog"];
		$result = getBlogDetail($id_blog);
		$log->trace("Detalle de blog: ".$result);
		echo json_encode($result);
	}
}
  ?>