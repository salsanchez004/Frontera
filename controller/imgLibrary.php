...
function construyeRender($Bbq, $meses, $relativo, $url_controller)
{
	try {
		...
		DibujaMultitexto($group, "El día ".$bbq_date." a las ".$bbq_time." hrs.\nEn ".$bbq_address, "../fonts/QuadonMedium.otf", 19,'#ffffff',0,529,800,69,3,0,1.2,3);
		...
		DibujaMultitexto($group, $bbq_message, "../fonts/QuadonMedium.otf", 20,'#ffffff',45,946,341,431,2,0,1.2,3);
		...
		for($i=0; $i<count($Bbq->getProducts()); $i++) {
			...
			DibujaMultitexto($group, $texto_producto, "../fonts/QuadonMedium.otf", 18,'#ffffff',$xProd + 18,$yProd - 6,310,55,2,0,1.2,3);
