...
jQuery(function ($) {
    ...
    $(window).on('scroll', function () {
		...
		if ($(this).scrollTop() > 100) {
			$('.scroll-tiendas-down').fadeOut('slow');
		}
		else {
			$('.scroll-tiendas-down').fadeIn('slow');
		}
    });
   ...
   ====================================== */
    ...
    $("#product_slider").owlCarousel({
	 ...
	 $("#product_slider_mobile").owlCarousel({
		items: 1,
        dots: true,
        nav: true,
		//autoWidth: true,
...
//    });
    ...
    $("#submit_btn").click(function () {
        ...
        if (proceed) {
            ...
            output = '<div class="alert-danger" style="padding:10px; margin-bottom:30px;">Por favor ingresa los campos solicitados.</div>';
            $("#result").hide().html(output).slideDown();
  ...
  * ============================================*/
    ...
    $("#rev_slider_19_1").show().revolution({
        ...
        responsiveLevels: [2000,1600, 1030, 778, 480],
        visibilityLevels: [2000,1600, 1030,778, 480],
        gridwidth: [2000,1600, 1030, 778, 480],
		gridheight: [969,754, 648, 960, 720],
        lazyType: "none",
        scrolleffect: {
            on_slidebg: "on",
        },
